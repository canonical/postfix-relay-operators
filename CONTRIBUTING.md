...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/postfix-relay-operators)
...
Canonical welcomes contributions to the Postfix Relay Operator. Please check out our
...
OCI image for the Postfix Relay app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./postfix-relay*.charm 
```
